...
const ProjectCard = ({ project }: { project: Project }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={handleDialogOpenChange}>
        ...
        <div className="relative w-full max-w-xs mx-auto space-y-2 overflow-hidden group cursor-pointer">
            <div className="w-full shadow hover:shadow-lg relative overflow-hidden rounded-xl transition-all duration-300">
              <img
                ...
                alt={project.title}
                className="w-full md:aspect-[3/6] object-contain transition-transform duration-500 group-hover:scale-110"
              />
      ...
      >
        <div className="flex flex-col md:flex-row max-h-[80vh] overflow-y-auto border border-right">
          {/* Left: Carousel */}
                  ...
                  <CarouselItem key={index}>
                    <div className="flex items-center justify-center p-0">
                      <img
                        ...
                        className="w-full aspect-[4/3] md:aspect-auto object-contain"
                      />
                    </div>
                  </CarouselItem>
                ))}
...
const Projects = () => {
  return (
    ...
    >
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
